...
import RefundRequestList from "./refundRequestList/refundRequestList";
			...
			<Grid item xs={12} ml={2} align="center">
				<Box sx={{ width: "100%", maxWidth:"sm", typography: "body1" }}>
					<TabContext value={value}>
						...
						<TabPanel value="1"><RefundRequestList mode={value}/></TabPanel>
						<TabPanel value="2"><RefundRequestList mode={value}/></TabPanel>
						<TabPanel value="3"><RefundRequestList mode={value}/></TabPanel>
						<TabPanel value="4"><RefundRequestList mode={value}/></TabPanel>
					</TabContext>
				</Box>
			</Grid>
		</Grid>
