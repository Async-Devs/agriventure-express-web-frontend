...
function AddProducers(){
	...
	function handleSubmit(){
		...
		&& validateNonEmpty(nic) && validateNonEmpty(address) && validateNonEmpty(district) && validateNonEmpty(city)
					...
					<Grid item xs={12}>
						...
						<Paper variant="elevation" elevation={3}>
							<Grid container mt={2} spacing={1} padding={1}>
								...
								<Grid item hidden={cities.length === 0} xs={12} md={6}>
									<ListInput name="city" label="City" value={city} onChange={onChange} required={true} options={cities} multi={false}/>
								</Grid>
							</Grid>
						</Paper>
					</Grid>
