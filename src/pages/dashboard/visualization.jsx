	...
	return(
		<div> <button onClick={updateData}>Click me</button>
			<Grid container spacing={5} justifyContent="center" sx={{marginTop:5}}>
				<Grid item xs={10} md={5.6} textAlign={"center"}>
				...
				<Grid item xs={10} md={5.6} textAlign={"center"}>
					<Paper sx={{boxShadow: 5, padding:"25px"}}>
						<div style={{display:"flex", justifyContent:"space-evenly"}}>
							<div><h2 style={{fontSize:"20px",fontFamily: "Montserrat", marginTop:"0px",marginBottom:"20px" }}>Crop sale data</h2></div>
				...
				<Grid item xs={10} md={6.859} textAlign={"center"}>
					<Paper sx={{boxShadow: 5, padding:"25px"}}>
